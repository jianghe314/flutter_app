...
import 'package:flutter_app/shopping/shoppingcart.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //ShoppingCart shoppingCart=ShoppingCart(name: "小王");
    //shoppingCart.bookings=[Item(2.5,"香蕉"),Item(5.2,"苹果")];
    //print("---------------------------------------"+shoppingCart.code);
    //shoppingCart.myprintInfo();
    return MaterialApp(
      title: 'Flutter Demo',
      theme: ThemeData(
